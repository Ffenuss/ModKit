...
class EngineResultCache(
    ...
    fun restorePartialResult(artifactSha256: String): FastAnalysisResult? {
        ...
        val flutterInventory = loadFlutterAssetInventory(artifactSha256)
        ...
        val cacheHits = buildSet {
            ...
            if (flutterInventory != null) add(FLUTTER_ASSET_INVENTORY_ENGINE_ID)
        ...
        var result = FastAnalysisResult(
            ...
            flutterAssetInventory = flutterInventory,
            il2cppFastDump = dump,
    ...
    fun loadFlutterAssetInventory(artifactSha256: String): FlutterAssetInventoryResult? =
        load(
            artifactSha256, FLUTTER_ASSET_INVENTORY_ENGINE_ID,
            FLUTTER_ASSET_INVENTORY_ENGINE_VERSION, FlutterAssetInventoryResult::class.java,
        )

    fun saveFlutterAssetInventory(
        artifactSha256: String, result: FlutterAssetInventoryResult,
    ): Boolean = save(
        artifactSha256, FLUTTER_ASSET_INVENTORY_ENGINE_ID,
        FLUTTER_ASSET_INVENTORY_ENGINE_VERSION, result,
    )
    ...
    companion object {
        ...
        const val FLUTTER_ASSET_INVENTORY_ENGINE_ID = "flutter.asset-inventory"
        const val FLUTTER_ASSET_INVENTORY_ENGINE_VERSION = "1"
